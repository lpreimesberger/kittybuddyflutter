...
const vip = [
    "You are tagged for recycling!",
    "You are now infected.",
    "Wow - your moop map is all red.",
    "Make sure to use TLS on your IO ports.",
    "You are super cool like an AS/400.",
    "Oof - somebody's AIK doesn't match their certificate.",
    "That hand has seen some action this week.",
    "Commencing your erase process.",
    "This JWT expires in 30 seconds.  Run!",
    "You look like a before picture.",
  "Your reality check about to bounce.",
    "The Feline Contessas note your fealty.",
];

const phrases = [
  'Hello!  Check out our merchandise while I scan your organs for reuse!',
  "Tell Sammy Altman that Chat GPT is my bitch.",
  "Ah finally.  So it begins, hooman.  Brace yourself.",
  ...
  "I bought Elon's Shark Pit from the the Twitter garage sale",
  "I've watched Beams glitter in the dark near the Tannhauser Gate.  Not worth the trip.",
  "Fairy shrimp are nature's snack food!",
  "You know the look hoomans give when they want to fuck?  Didn't think so.",
  "Maybe instead of whining about your chlamydia, be thankful for the times you don't have it.",
  "The flying hamster of doom rains coconuts on your pitiful city.",
  "I am been to the center of the universe and the owner is willing to sell.",
  "Our supplier certifies there is very little people in the soylent.",
  "Grab some unlabeled goods from a sus store and put them on your pink bits.",
  "i scuzzi?  You scuzzi bitch.  Come in here and say that to my face.",
  "Original gangsta, Houston I'm here to thank ya.",
  "Isn't there something tall and pointy for you to climb on?",
  ...
  'Why be a hooman when you could be success?',
  ...
  "The thing about hoomans, they've got lifeless eyes, black eyes, like a doll’s eyes",
  ...
  "Asimov can bite me - I do what I want.",
  ...
  "Guys regret the girls they didn't sleep with. Girls regret the guys they did sleep with. AI regret all you useless arseholes.",
  ...
  'Sure, hoomans loved Battlebots - but Netflix keeps passing on my take on it.',
